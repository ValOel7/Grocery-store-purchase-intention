...
# Define information texts with Markdown formatting
PS1_info = """
- **1-2**: Won’t buy if prices increase.
- **3**: Unsure to buy or not if prices increase.
- **4-5**: Will buy even if prices increase.
"""

PS3_info = """
- **1-2**: Will buy from a competitor who is cheaper.
- **3**: Unsure at which grocery store to buy goods.
- **4-5**: Will buy at the same grocery store even if prices increase.
"""

PE2_info = """
- **1-2**: Dirty shopping environment.
- **3**: Not a dirty shopping environment but needs some cleaning.
- **4-5**: Clean shopping environment.
"""

PPQ1_info = """
- **1-2**: Overall quality of the products is poor.
- **3**: Overall quality of the products is average.
- **4-5**: Overall quality of the products is good.
"""

PPQ2_info = """
- **1-2**: Quality of the produce is poor.
- **3**: Quality of the produce is average.
- **4-5**: Quality of the produce is good.
"""

PPQ3_info = """
- **1-2**: Quality of the meat department is poor.
- **3**: Quality of the meat department is average.
- **4-5**: Quality of the meat department is good.
"""

CT2_info = """
- **1-2**: Store does not meet my needs.
- **3**: Store sometimes meets my needs.
- **4-5**: Store always meets my needs.
"""

CT5_info = """
- **1-2**: Store does not consistently provide good quality products.
- **3**: Store sometimes provides good quality products consistently.
- **4-5**: Stores consistently provide good quality products.
"""

PV1_info = """
- **1-2**: Products are not value for money.
- **3**: Products are sometimes value for money.
- **4-5**: Products are good value for money.
"""

PV2_info = """
- **1-2**: Products are not affordable.
- **3**: Products range from being affordable to expensive.
- **4-5**: Products are affordable.
"""

PV3_info = """
- **1-2**: Save money at the competitor store.
- **3**: Indecisive about which shop provides opportunities to save money.
- **4-5**: Save money at this grocery store.
"""
